    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-2">
        ...
        <div className="flex gap-2">
          <input className="flex-1" onChange={e => setLinkInput(e.target.value)} value={linkInput} type="text" placeholder="Paste the link and click on Add"/>
        ...
        <CldUploadButton onUpload={handleImageUpload} className={`${imageUrl && 'pointer-events-none'} relative h-48 border-2 mt-4 border-dotted grid place-items-center rounded-md bg-slate-100`} uploadPreset={process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_PRESET}>
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
              <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 15.75 5.159-5.159a2.25 2.25 0 0 1 3.182 0l5.159 5.159m-1.5-1.5 1.409-1.409a2.25 2.25 0 0 1 3.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 0 0 1.5-1.5V6a1.5 1.5 0 0 0-1.5-1.5H3.75A1.5 1.5 0 0 0 2.25 6v12a1.5 1.5 0 0 0 1.5 1.5Zm10.5-11.25h.008v.008h-.008V8.25Zm.375 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Z" />
            </svg>
          </div>
          {imageUrl && (<Image src={imageUrl} fill alt={title} className="absolute object-cover inset-0"/>)}
        </CldUploadButton>
